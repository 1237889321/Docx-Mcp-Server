...
if (useHttp) {
  ...
  app.post('/extract_text', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/convert_to_html', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/analyze_structure', async (req: Request, res: Response) => {
    try {
      const { file_path } = req.body
      const result = await analyzeStructure(file_path)
      res.json(result)
  ...
  app.post('/extract_images', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/convert_to_markdown', async (req: Request, res: Response) => {
    try {
      const { file_path } = req.body
      const result = await convertToMarkdown(file_path)
      res.json(result)
